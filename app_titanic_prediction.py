...
def main():
	...
	st.image("https://cdn1.naekranie.pl/media%2Fcache%2Farticle-cover%2F2022%2F12%2FTitanic_639d7a5bf16e3.jpeg")
	...
	with right:
		age_slider = st.slider("Wiek", value=1, min_value=1, max_value=85)
		...
		fare_slider = st.slider("Cena biletu", min_value=0, max_value=250, step=1)
